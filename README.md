...
## 👋 Intro
안녕하세요! **"항상 새로운 것을 배우고 도전하고 싶은"** KiHeon-Jeong 입니다.

데이터 기반 문제 해결에 관심이 많고, 분석 결과를 실제 서비스/케어 까지 연결하는 비전을 지향합니다.

저에 대한 더 자세한 내용은 아래 섹션에서 확인하실 수 있습니다.
...
### 01. AI 기반 통합 면역·영양 맞춤 케어 시스템  
> 데이터 기반 면역 취약성 예측과 영양 분석을 통해 요양원 민감계층을 위한 맞춤형 케어 가이드를 제공하는 통합 관리 플랫폼  
> 한국오라클 의료바이오 데이터 전문가 과정  
> 수행 기간: 2026.01.20 ~ 2026.02.27  
> 수행 역할: 팀장(PM), 프로젝트 기획 및 분석 총괄, Frontend 구축, Backend 연동  
